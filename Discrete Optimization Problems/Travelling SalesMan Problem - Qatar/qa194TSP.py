...
def main():
    ...
    sys.stdout = open("./qa194/epochs.txt", "w")
    #Calling satsp method to solve the TSP problem
    start_time = time.time()
    solver.Solve(coordinates, epochs=1000, start_temp=1000, alpha=0.99, epoch_length_factor=1.02)
    time_taken = time.time() - start_time
    
    with open("./qa194/output.txt", "a") as f:
